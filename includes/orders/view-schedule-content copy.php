        ...
        <form id="cancelMealForm" method="POST">
          ...
          <div class="modal-header">
            <div class="d-flex justify-content-start gap-2 align-items-center">
              <h5 class="modal-title" id="cancelModalLabel">Cancel & Reschedule Meal</h5>
              <span id="cancel-meal-date" class="btn btn-secondary btn-sm border rounded" style="background-color: #f8f9fa; border-color: #f8f9fa; color: #000;">
              </span>
            </div>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          ...
          <div class="modal-body">
            ...
            <div class="alert alert-info" role="alert" id="cancel-modal-text">
              You're rescheduling the <b><span id="selected-meal-type"></span></b> meal. It won't be canceled-just moved to a new date and time.
            </div>
            ...
            <div id="reschedule-section">
              <div class="row">
                <div class="col-md-6 mb-3">
                  ...
                  <input type="date" class="form-control" name="reschedule_date" id="reschedule-date" required>
                  <div class="invalid-feedback">Date cannot be in the past.</div>
                </div>
                <div class="col-md-6 mb-3">
