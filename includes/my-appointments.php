...

{
  ...
  echo '<th style="width: 150px;">' . esc_html__('Dietitian Note', 'your-text-domain') . '</th>';
  ...
  foreach ($appointments as $appointment) {
    ...
    // Fetch dietitian note from order meta

    $dietitian_note = get_post_meta($order_id, 'dietitian_note', true);

    $dietitian_note_display = !empty($dietitian_note) ? esc_html($dietitian_note) : '';
    ...
    echo '<td>' . $dietitian_note_display . '</td>';
